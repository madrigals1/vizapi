...
async function main() {
  ...
  console.log(await fetch('POST', '/table', {
    table: [
      ...
      { 'Region': '✔️ North Atlantic Coastal Region Including All Major Shipping Lanes and International Waters', 'Product': 'Widget Pro Ultra Premium Edition with Extended Cloud Storage and Priority Support', Q1: 9800, Q2: 10200, Q3: 11500, Q4: 12100, Total: 43600 },
      ...
      { 'Region': '☑️ Sub-Saharan African Development Corridor with Focus on Sustainable Infrastructure Projects', 'Product': 'DataFlow Real-time Streaming Analytics Platform with Apache Kafka Integration Support', Q1: 6400, Q2: 7100, Q3: 7800, Q4: 8400, Total: 29700 },
  ...
  console.log(await fetch('POST', '/compare', {
    left: {
      ...
      compare_fields: [
        ...
        { name: 'Stability', value: undefined },
